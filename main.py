...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](16):[/cyan] [green]Unlock Disable Damage ~ FREE[/green]")
            console.print("[bold][cyan](17):[/cyan] [green]Unlock Unlimited Fuel ~ FREE[/green]")
            ...
            if service == 0: # Exit
                ...
                console.print("[bold cyan][%] Saving your data[/bold cyan]: ", end=None)
                if len(new_id) >= 2 and len(new_id) <= 100 and (' ' in new_id) == False:
